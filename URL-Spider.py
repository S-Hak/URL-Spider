...
# 打开文件
try:
    FILE20X = open("./Output/20x.txt", "w+")
    FILE40X = open("./Output/40x.txt", "w+")
    FILE403 = open("./Output/403.txt", "w+")
    FILEOTHER = open("./Output/other.txt", "w+")
except:
    print("未发现Output文件夹，开始尝试创建 >>>  ")
    os.mkdir("./Output")
...
def over_url(url_list, url):
    ...
    for i in url_list:
        ...
        try:
            ...
            continue
        #==============================================================================================
        if not over_url_a in REPEAT_LIST: REPEAT_LIST.append(over_url_a)
    return C200_LISTS
